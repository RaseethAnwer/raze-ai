...
public class NemotronService {
    ...
    @Value("${nemotron.api.key}")
    private String apiKey;

    private static final String OPENROUTER_URL = "https://openrouter.ai/api/v1/chat/completions";

    public String call(String message, MultipartFile image) {
        // Image handling omitted; can be extended to include base64 image data.
        return callOpenRouter("nvidia/llama-3.1-nemotron-70b-instruct", message);
    }
    ...
    private String callOpenRouter(String model, String message) {
        ...
        try {
            ...
            return "Nemotron Error: " + e.getMessage();
        }
    }
}
