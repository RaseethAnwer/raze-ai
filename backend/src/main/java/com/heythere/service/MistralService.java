...
public class MistralService {
    ...
    public String call(String message, MultipartFile image) {
        // Image handling omitted for brevity; can be extended to include base64 image data.
        return callOpenRouter("mistralai/mistral-small-24b-instruct-2501", message);
    }
